...
function VaultLocked({ onUnlock }) {
  ...
  return (
    ...
    >
      ...
      {/* Slow red radial glow — top right */}
      <div style={{
      ...
      {/* Slow cold glow — bottom left */}
      <div style={{
        position: "fixed", bottom: "-20%", left: "-10%",
        width: "50vw", height: "50vw",
        background: "radial-gradient(circle, rgba(44,74,94,0.10) 0%, transparent 70%)",
        pointerEvents: "none", zIndex: 0,
      ...
      <nav style={{
        ...
        <div style={{
          ...
          fontSize: "18px", letterSpacing: "-0.01em", color: "#f5f4f1",
        }}>
          AWS
        </div>
        <div style={{
      ...
      <main style={{
        ...
        padding: "60px 24px", position: "relative", zIndex: 5,
        textAlign: "center",
      }}>

        {/* LANDING PHASE */}
        {phase === "landing" && (
          <div style={{ animation: "fadeUp 0.8s ease forwards", maxWidth: "780px" }}>

            {/* Classified badge */}
            <div style={{
              display: "inline-flex", alignItems: "center", gap: "8px",
              border: "1px solid rgba(139,30,30,0.4)",
              padding: "6px 16px", marginBottom: "48px",
              ...
              <span style={{
                ...
                background: "#8b1e1e", animation: "blink 2s ease-in-out infinite",
            ...
            <h1 style={{
              ...
              marginBottom: "32px", color: "#f5f4f1",
              animation: glitching ? "glitch 0.15s steps(2) forwards" : "none",
              position: "relative",
            }}>
              ADAM W.<br />
            ...
            <p style={{
              ...
              textTransform: "uppercase", color: "rgba(245,244,241,0.25)",
              marginBottom: "64px",
            }}>
            ...
            <div style={{
              margin: "0 auto 64px", maxWidth: "560px",
              textAlign: "left",
              borderLeft: "2px solid rgba(139,30,30,0.4)",
              paddingLeft: "24px",
            }}>
              {[
                ...
                <p key={i} style={{
                  fontFamily: line.includes("█") ? "'JetBrains Mono', monospace" : "'DM Sans', sans-serif",
                  fontSize: line.includes("█") ? "13px" : "17px",
                  lineHeight: 1.7,
                  color: line === "Fraud. Deceit. Corruption. Theft."
                    ? "rgba(139,30,30,0.9)"
                    : line.includes("█")
                    ? "rgba(245,244,241,0.1)"
                    : line === "It wasn't." || line === "He stood back up." || line === "He always does."
                    ? "rgba(245,244,241,0.95)"
                    : "rgba(245,244,241,0.65)",
                  margin: 0,
                  letterSpacing: line.includes("█") ? "0.05em" : "normal",
                  fontWeight: line === "Fraud. Deceit. Corruption. Theft." || line === "It wasn't." || line === "He always does." ? 700 : 400,
                }}>
                  {line}
                </p>
              ))}
            ...
            <div style={{
              ...
              {[
                ...
                <div key={stat} style={{ textAlign: "center" }}>
                  <div style={{
                    fontFamily: "'Syne', sans-serif", fontWeight: 800,
                    fontSize: "24px", color: "#f5f4f1", marginBottom: "4px",
                  }}>
                    {stat}
                  </div>
                  <div style={{
                    ...
                    textTransform: "uppercase", color: "rgba(245,244,241,0.3)",
                  }}>
                    {label}
                  </div>
                </div>
